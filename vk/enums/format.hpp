...
public:
  Format(Values value) : m_value(value) {}
  constexpr Format(VkFormat value) : m_value(std::bit_cast<Values>(value)) {}

  operator VkFormat() const { return std::bit_cast<VkFormat>(m_value); }
};
} // namespace vk
